    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-40 pb-24 px-12 md:px-32 lg:px-48 max-w-[1400px] mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-[#555555]">
          <p className="mb-8">Your privacy is critically important to us. This Privacy Policy document contains types of information that is collected and recorded by Optical Galaxy and how we use it.</p>
          ...
          <p className="mb-8">Optical Galaxy uses cookies to store information about visitors' preferences and the pages on the website that the visitor accessed or visited.</p>
        </div>
      </section>
      <Footer />
    </main>
