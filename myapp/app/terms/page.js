    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-40 pb-24 px-12 md:px-32 lg:px-48 max-w-[1400px] mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-[#555555]">
          <p className="mb-8">Welcome to Eyeconic. These terms and conditions outline the rules and regulations for the use of Eyeconic's Website.</p>
          <h3 className="text-xl font-black uppercase mb-4 text-black">1. INTRODUCTION</h3>
          <p className="mb-8">By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Eyeconic's website if you do not accept all of the terms and conditions stated on this page.</p>
          <h3 className="text-xl font-black uppercase mb-4 text-black">2. INTELLECTUAL PROPERTY RIGHTS</h3>
          <p className="mb-8">Unless otherwise stated, Eyeconic and/or its licensors own the intellectual property rights for all material on Eyeconic. All intellectual property rights are reserved.</p>
